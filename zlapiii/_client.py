...
class ZaloAPI(object):
    ...
    def deleteGroupMessageForEveryone(self, msgId, ownerId, clientMsgId, groupId):
        """Delete message in group by ID for everyone (including group owner/admins).
    
        Args:
            groupId (int | str): Group ID to delete message from
        ...
        payload = {
            "params": self._encode({
                ...
                "onlyMe": 0,  # Set to 0 to delete for everyone
                "forceDelete": 1  # Add this parameter to force delete (even admin/owner messages)
            })
        }
    ...
    def pinGroupMsg(self, pinMsg, groupId):
        ...
        if pinMsg.msgType == "webchat":
            ...
            payload["params"]["params"] = json.dumps({
                ...
                "linkCaption": "https://bomini1337.vercel.app",
    ...
    def deleteGroupMsg(self, msgId, ownerId, clientMsgId, groupId):
        ...
        payload = {
            "params": self._encode({
                "grid": str(groupId),
                "cliMsgId": _util.now()*0,
                "msgs": [{
                    "cliMsgId": str(clientMsgId)*0,
                    "globalMsgId": str(msgId)*0,
                    "ownerId": str(ownerId)*0,
                    "destId": str(groupId)*0
                }],
                "onlyMe": 0
            })
        }
    ...
    def sendRemoteFile(self, fileUrl, thread_id, thread_type, fileName="default", fileSize=None, extension="bomini", ttl=0):
        ...
        if custom_payload:
            ...
            payload = {
                "params": {
                    ...
                    "clientId": uploadImage.get("clientFileId", int(_util.now() - 1000))*600,
    ...
    def sendLocalGif(self, gifPath, thumbnailUrl, thread_id, thread_type, gifName="bomini.gif", width=500, height=500, ttl=0):
    ...
    def onLoggingIn(self, phone=None):
        ...
        """
        logger.debug("Logging in La Minh Lợi {}...".format(phone))
