		...
		if parse_mode:
			if self.parse_mode == "RAINBOW":
				...
				for idx, char in enumerate(self.text):
					...
					rainbow_styles.append(style)
				self.style = MultiMsgStyle(rainbow_styles)
				...
				if self.parse_mode == "Markdown":
					...
					raise ValueError("Invalid Parse Mode, Only Support `Markdown`, `HTML`, or `RAINBOW`")
